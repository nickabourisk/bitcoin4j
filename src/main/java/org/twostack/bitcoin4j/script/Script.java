...
public class Script {
    ...
    /**
      Bitcoind ASM strings prepend OpCodes with OP_ and have some other quirks related
      to Data pushes. This is here primarily for compatibility with bsv JS library
      and also ASM strings generated by sCrypt IDE
     */
    public static Script fromBitcoindAsmString(String string) throws IOException {
